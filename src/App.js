      ...
      <div className="search-div">
        ...
        <div className="top">
          ...
          <div className="location">
            <p>
              {data.name ? (
                <p>{data.name.replace('Arrondissement de', ' ')}</p>
              ) : (
                ' '
              )}
            </p>
          </div>
          <div className={data.main ? colorSwitch(data.main.temp) : "temp"}>
        ...
        <div className="bottom">
          ...
          <div className="humidity">
            <p>Humidité : </p> {data.main ? <p>{data.main.humidity} %</p> : ' '}
          </div>
          <div className="wind-speed">
            <p>Vent : {data.wind ? <p>{data.wind.speed} KM/H </p> : ' '} </p>
          </div>
        </div>
      </div>
    </div>
